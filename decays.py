...
Decay_b = Decay(name = 'Decay_b',
                ...
                partial_widths = {(P.W__minus__,P.t):'(((3*ee**2*MB**2)/(2.*sw**2) + (3*ee**2*MT**2)/(2.*sw**2) + (3*ee**2*MB**4)/(2.*MW**2*sw**2) - (3*ee**2*MB**2*MT**2)/(MW**2*sw**2) + (3*ee**2*MT**4)/(2.*MW**2*sw**2) - (3*ee**2*MW**2)/sw**2)*cmath.sqrt(MB**4 - 2*MB**2*MT**2 + MT**4 - 2*MB**2*MW**2 - 2*MT**2*MW**2 + MW**4))/(96.*cmath.pi*abs(MB)**3)',
                                  (P.Zp,P.s):'((3*delbs**2*gb**2*MB**2 + 3*delbs**2*gb**2*MS**2 + (3*delbs**2*gb**2*MB**4)/MZp**2 - (6*delbs**2*gb**2*MB**2*MS**2)/MZp**2 + (3*delbs**2*gb**2*MS**4)/MZp**2 - 6*delbs**2*gb**2*MZp**2)*cmath.sqrt(MB**4 - 2*MB**2*MS**2 + MS**4 - 2*MB**2*MZp**2 - 2*MS**2*MZp**2 + MZp**4))/(96.*cmath.pi*abs(MB)**3)'})
...
Decay_s = Decay(name = 'Decay_s',
                ...
                partial_widths = {(P.W__minus__,P.c):'(((3*ee**2*MC**2)/(2.*sw**2) + (3*ee**2*MS**2)/(2.*sw**2) + (3*ee**2*MC**4)/(2.*MW**2*sw**2) - (3*ee**2*MC**2*MS**2)/(MW**2*sw**2) + (3*ee**2*MS**4)/(2.*MW**2*sw**2) - (3*ee**2*MW**2)/sw**2)*cmath.sqrt(MC**4 - 2*MC**2*MS**2 + MS**4 - 2*MC**2*MW**2 - 2*MS**2*MW**2 + MW**4))/(96.*cmath.pi*abs(MS)**3)',
                                  (P.Zp,P.b):'((3*delbs**2*gb**2*MB**2 + 3*delbs**2*gb**2*MS**2 + (3*delbs**2*gb**2*MB**4)/MZp**2 - (6*delbs**2*gb**2*MB**2*MS**2)/MZp**2 + (3*delbs**2*gb**2*MS**4)/MZp**2 - 6*delbs**2*gb**2*MZp**2)*cmath.sqrt(MB**4 - 2*MB**2*MS**2 + MS**4 - 2*MB**2*MZp**2 - 2*MS**2*MZp**2 + MZp**4))/(96.*cmath.pi*abs(MS)**3)'})
...
Decay_Zp = Decay(name = 'Decay_Zp',
                 particle = P.Zp,
                 partial_widths = {(P.b,P.b__tilde__):'((-6*gb**2*MB**2 + 6*gb**2*MZp**2)*cmath.sqrt(-4*MB**2*MZp**2 + MZp**4))/(48.*cmath.pi*abs(MZp)**3)',
                                   (P.b,P.s__tilde__):'((-3*delbs**2*gb**2*MB**2 - 3*delbs**2*gb**2*MS**2 - (3*delbs**2*gb**2*MB**4)/MZp**2 + (6*delbs**2*gb**2*MB**2*MS**2)/MZp**2 - (3*delbs**2*gb**2*MS**4)/MZp**2 + 6*delbs**2*gb**2*MZp**2)*cmath.sqrt(MB**4 - 2*MB**2*MS**2 + MS**4 - 2*MB**2*MZp**2 - 2*MS**2*MZp**2 + MZp**4))/(48.*cmath.pi*abs(MZp)**3)',
                                   (P.mu__minus__,P.mu__plus__):'((8*gmu**2*MMU**2 + 4*gmu**2*MZp**2)*cmath.sqrt(-4*MMU**2*MZp**2 + MZp**4))/(48.*cmath.pi*abs(MZp)**3)',
                                   (P.s,P.b__tilde__):'((-3*delbs**2*gb**2*MB**2 - 3*delbs**2*gb**2*MS**2 - (3*delbs**2*gb**2*MB**4)/MZp**2 + (6*delbs**2*gb**2*MB**2*MS**2)/MZp**2 - (3*delbs**2*gb**2*MS**4)/MZp**2 + 6*delbs**2*gb**2*MZp**2)*cmath.sqrt(MB**4 - 2*MB**2*MS**2 + MS**4 - 2*MB**2*MZp**2 - 2*MS**2*MZp**2 + MZp**4))/(48.*cmath.pi*abs(MZp)**3)',
                                   (P.t,P.t__tilde__):'((-6*gb**2*MT**2 + 6*gb**2*MZp**2)*cmath.sqrt(-4*MT**2*MZp**2 + MZp**4))/(48.*cmath.pi*abs(MZp)**3)',
                                   (P.ta__minus__,P.ta__plus__):'((8*gtau**2*MTA**2 + 4*gtau**2*MZp**2)*cmath.sqrt(-4*MTA**2*MZp**2 + MZp**4))/(48.*cmath.pi*abs(MZp)**3)',
                                   (P.vm,P.vm__tilde__):'(gmu**2*MZp**4)/(24.*cmath.pi*abs(MZp)**3)',
                                   (P.vt,P.vt__tilde__):'(gtau**2*MZp**4)/(24.*cmath.pi*abs(MZp)**3)'})
